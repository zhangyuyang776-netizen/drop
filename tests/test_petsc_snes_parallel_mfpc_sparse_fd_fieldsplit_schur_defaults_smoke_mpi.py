...
def test_mfpc_sparse_fd_fieldsplit_schur_defaults_smoke_mpi(tmp_path: Path):
    ...
    assert split_cfgs.get("bulk", {}).get("pc_type") == "asm"
    assert split_cfgs.get("bulk", {}).get("subdomain_pc_type") == "ilu"
    assert split_cfgs.get("iface", {}).get("pc_type") == "ilu"
