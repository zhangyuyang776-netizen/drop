...
@pytest.mark.mpi
def test_p3_5_2_3_additive_defaults_injected_mpi(tmp_path: Path):
    (
        _build_precond_matrix,
        _build_shell_like_matrix,
        _get_fieldsplit_subksps,
    ...
    assert injected.get("fieldsplit_iface_sub_pc_type") == "ilu"
    ...
    for sksp in subksps:
        spc = sksp.getPC()
        assert spc.getType().lower() == "asm"


@pytest.mark.mpi
def test_p3_5_2_3_additive_yaml_override_injected_mpi(tmp_path: Path):
    (
        _build_precond_matrix,
        _build_shell_like_matrix,
        _get_fieldsplit_subksps,
